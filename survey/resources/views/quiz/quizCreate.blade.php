...
<div class="card uper">
  ...
  <div class="card-header">
   ...
   <div class="card-body">
    ...
    @endif
      <form method="post" enctype="multipart/form-data" action="{{route('storeQuiz')}}">
        <input type="hidden" name="added_by" value="{{Auth::user()->id}}">
          <div class="form-group">
           ...
           <div class="form-group">
               ...
               <input type="textarea" class="form-control" name="question[]" value="{{old('question')}}"/>
              </div>

          <div class="form-group">
                <label for="options">Answer Options:</label>
                <textarea class="form-control"  id="options" name="options[]" row="3">{{old('options')}}</textarea>
              </div>
          
           <div class="form-group">
                <label for="right_answer">Right Answer:</label>
               <input type="textarea" class="form-control" name="right_answer[]" value="{{old('right_answer')}}"/>
              </div>
